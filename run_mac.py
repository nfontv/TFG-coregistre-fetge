...
#FILTRE_SEGMENTACIONS_CVS_PATH = Path('/Users/noemifontvoorhoeve/Desktop/CoregistreRigidFetge-main/filtre_segmentacions/metriques_filtre.csv')


#dataset del pen drive
DATASET_PATH = Path(r"I:\tgf noemi\data tgf noemi\manifest-1783073007564\HCC-TACE-Seg")
